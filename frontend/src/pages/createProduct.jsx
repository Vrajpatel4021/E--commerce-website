            ...
            <div className='w-[90%] max-w-[500px] bg-cyan-50 shadow-md h-auto rounded-md p-6 mx-auto mt-8 sm:mt-16 lg:mt-24  justify-center mb-24 mr-10 ml-10'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='mt-4'>
                        ...
                        <textarea value={description} className='w-full p-2 border rounded-sm focus:outline-none focus:ring-2 focus:ring-blue-400 hover:shadow-lg transition-shadow duration-200 resize-none' rows='3' cols='40' onChange={(e) => setDescription(e.target.value)} placeholder='Provide the product description'></textarea>
                    </div>
                    <div className='mt-4'>
                        <label className='pb-1 block text-gray-600 font-medium'>
                    ...
                    <div className='mt-4'>
                        ...
                        <input type="text" value = {tags} className='w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 hover:shadow-lg transition-shadow duration-200' onChange={(e) => setTags(e.target.value)} placeholder='Enter Tags...' required/>
                    </div>
                    <div className='mt-4'>
                        <label className='pb-1 block text-gray-600 font-medium'>
                            Price <span className='text-red-500'>*</span>
                        </label>
                        <input type="number" value = {price} className='w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 hover:shadow-lg transition-shadow duration-200' onChange={(e) => setPrice(e.target.value)} placeholder='Enter Product Price...' required/>
                    </div>
                    <div className='mt-4'>
                        <label className='pb-1 block text-gray-600 font-medium'>
                            Stock <span className='text-red-500'>*</span>
                        </label>
                        <input type="number" value = {stock} className='w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 hover:shadow-lg transition-shadow duration-200' onChange={(e) => setStock(e.target.value)} placeholder='Enter Quantity...' required/>
                    </div>
                    <div className='mt-4'>
                        <label className='pb-1 block text-gray-600 font-medium'>
                        ...
                        <label htmlFor='upload' className='cursor-pointer flex items-center justify-center w-[100px] h-[100px] bg-gray-700 rounded-full hover:bg-gray-300 transition-colors duration-200'>
                    ...
                    <button type="submit" className='w-full mt-6 bg-blue-500 text-white p-3 rounded-full hover:bg-blue-600 transition-colors duration-200'>
                        Create
                    </button>
                </form>
            </div>
