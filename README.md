...
In this milestone we learned how to securely authenticate users using JWT stored in browser cookies. We implemented middleware to validate tokens on the backend and ensured that protected pages check for valid authentication, preventing unauthorized access.And also made the axios request handlers easier.